...
namespace WebShop_Auth.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login2(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    return RedirectToLocal2(returnUrl);
        ...
        //register2 custom theo mình tự thiết kế
        [AllowAnonymous]
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public string LogOff2(string messeger)
        {
        ...
        // custom redirectTolotcal theo y mình
        private ActionResult RedirectToLocal2(string returnUrl)
        {
            ...
            return RedirectToAction("Cart", "HomeShop");
        }
